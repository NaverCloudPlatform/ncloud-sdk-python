...
class GetServerProductListRequest(object):
    ...
    def __init__(self, exclusion_product_code=None, internet_line_type_code=None, product_code=None, generation_code=None, region_no=None, server_image_product_code=None, zone_no=None):  # noqa: E501
